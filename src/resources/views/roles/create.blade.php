...
@section('title', 'Add') {{-- For different pages you can change your title here --}}
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header" style="margin-top: 10px;">Add Role</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
...
@section('javascript')
    ...
    <script type="text/javascript" src="{{ url('AdminAsset/vendor/jquery/jquery.min.js') }}"></script>
